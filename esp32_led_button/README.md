  ...
  "Statement": [
    {
      "Effect": "Allow",
      "Action": "iot:Connect",
      "Resource": "arn:aws:iot:us-east-1:773454908973:client/LEDButton12345670"
    },
    {
      "Effect": "Allow",
      "Action": "iot:Receive",
      "Resource": [
        "arn:aws:iot:us-east-1:773454908973:topic/LEDButton12345670/command",
        "arn:aws:iot:us-east-1:773454908973:topic/$aws/things/LEDButton12345670/shadow/update/accepted",
        "arn:aws:iot:us-east-1:773454908973:topic/$aws/things/LEDButton12345670/shadow/update/rejected",
        "arn:aws:iot:us-east-1:773454908973:topic/$aws/things/LEDButton12345670/shadow/get/accepted",
        "arn:aws:iot:us-east-1:773454908973:topic/$aws/things/LEDButton12345670/shadow/get/rejected"
      ]
    },
    {
      "Effect": "Allow",
      ...
      "Resource": [
        "arn:aws:iot:us-east-1:773454908973:topicfilter/LEDButton12345670/command",
        "arn:aws:iot:us-east-1:773454908973:topicfilter/$aws/things/LEDButton12345670/shadow/update/accepted",
        "arn:aws:iot:us-east-1:773454908973:topicfilter/$aws/things/LEDButton12345670/shadow/update/rejected",
        "arn:aws:iot:us-east-1:773454908973:topicfilter/$aws/things/LEDButton12345670/shadow/get/accepted",
        "arn:aws:iot:us-east-1:773454908973:topicfilter/$aws/things/LEDButton12345670/shadow/get/rejected"
      ]
    },
    {
      "Effect": "Allow",
      "Action": "iot:Publish",
      "Resource": [
        "arn:aws:iot:us-east-1:773454908973:topic/LEDButton12345670/result",
        "arn:aws:iot:us-east-1:773454908973:topic/$aws/things/LEDButton12345670/shadow/update",
        "arn:aws:iot:us-east-1:773454908973:topic/$aws/things/LEDButton12345670/shadow/get"
      ]
    }
  ]
}
